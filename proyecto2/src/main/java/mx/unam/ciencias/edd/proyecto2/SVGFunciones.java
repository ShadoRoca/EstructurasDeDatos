...
public class SVGFunciones {
     ...
     * @return el codigo
     */
    public String escribeNum(int x, int y, int t, String color) {
        String texto = "<text x=\"" + x + "\" " + "y=\"" + y + "\" " + "text-anchor=\"middle\" "
                + "font-family=\"serif\" " + "font-size=\"25\" " + "fill=\"" + color + "\" " + "stroke=\"#000000\" "
                + ">" + t + "</text>";
        return texto + "\n";
    }
    ...
    public String dibujaVertices(VerticeArbolBinario<Integer> v, int xCoordenada, int yCoordenada, int proporcion) {
        ...
        String c = circulo(xCoordenada, yCoordenada, 50, "white")
                + escribeNum(xCoordenada, yCoordenada, v.get(), "black");
     ...
     * @return el codigo
     */
    public String dibujaLineas(VerticeArbolBinario<Integer> v, int xCoordenada, int yCoordenada, int proporcion) {
        if (v == null) {
            return "";
        }
        String l = "";
