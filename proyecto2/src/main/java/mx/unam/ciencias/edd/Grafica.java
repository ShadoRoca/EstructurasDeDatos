...
public class Grafica<T> implements Coleccion<T> {
    ...
    public void agrega(T elemento) {
        if (elemento == null || contiene(elemento)) {
            throw new IllegalArgumentException("Intentaste agregar un elemento que ya estaba en la gráfica o un elemento nulo");
        } else {
    ...
    public void conecta(T a, T b) {
        ...
        if (sonVecinos(a, b)) {
            throw new IllegalArgumentException("Los vértices " + a + "y " + b + " ya son vecinos");
        }
        x.vecinos.agrega(y);
        y.vecinos.agrega(x);
        aristas++;
