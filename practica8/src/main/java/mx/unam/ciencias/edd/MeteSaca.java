...
public abstract class MeteSaca<T> {
    ...
    public boolean equals(Object object) {
        ...
        Nodo recorreParametro = m.cabeza;
        Nodo recorre = cabeza;

        if (cabeza == null && m.cabeza == null)
            return true;
        while (recorre != null && recorreParametro != null)
            if (recorre.elemento.equals(recorreParametro.elemento)) {
        ...
        return recorreParametro == recorre;
    }
